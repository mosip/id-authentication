...
-- ddl-end --
COMMENT ON COLUMN idrepo.uin_biometric_h.parent_guardian_bio_file_id IS 'file id of the biometric cbeff file of individual''s parent / guardian';
-- ddl-end --
COMMENT ON COLUMN idrepo.uin_biometric_h.parent_guardian_bio_file_name IS 'Name of the biometric cbeff file of parent / guardian';
-- ddl-end --
COMMENT ON COLUMN idrepo.uin_biometric_h.parent_guardian_bio_file_hash IS 'Hash value of the biometric dbeff file of parent / guardian';
-- ddl-end --
