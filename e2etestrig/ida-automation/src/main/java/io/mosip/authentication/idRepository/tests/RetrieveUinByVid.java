 ...
 *
 */
public class RetrieveUinByVid extends IdRepoTestsUtil implements ITest {

	private static final Logger logger = Logger.getLogger(RetrieveUinByVid.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, RetrieveUinByVid.testCaseName);
		} catch (Exception e) {
	...
	public void RetrieveUIN(TestParameters objTestParameters, String testScenario,
		...
		getRequestAndGenerateOuputFileWithResponse(testCaseName.getPath(),IdRepoUtil.getRetrieveUINByVIDPath(vidNumber),"output-1-actual-res",AUTHORIZATHION_COOKIENAME,cookieValue);
