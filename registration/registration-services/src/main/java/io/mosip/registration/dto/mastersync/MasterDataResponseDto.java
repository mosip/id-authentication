...
public class MasterDataResponseDto {
	...
	/*public List<DeviceProviderDto> getDeviceProviders() {
		return deviceProviders;
	}

	public void setDeviceProviders(List<DeviceProviderDto> deviceProviders) {
		this.deviceProviders = deviceProviders;
	}

	public List<FoundationalTrustProviderDto> getFoundationalTrustProviders() {
		return foundationalTrustProviders;
	}

	public void setFoundationalTrustProviders(List<FoundationalTrustProviderDto> foundationalTrustProviders) {
		this.foundationalTrustProviders = foundationalTrustProviders;
	}

	public List<MosipDeviceServiceDto> getMosipDeviceServices() {
		return mosipDeviceServices;
	}

	public void setMosipDeviceServices(List<MosipDeviceServiceDto> mosipDeviceServices) {
		this.mosipDeviceServices = mosipDeviceServices;
	}

	public List<RegisteredSubDeviceTypeDto> getRegisteredSubDeviceTypes() {
		return registeredSubDeviceTypes;
	}

	public void setRegisteredSubDeviceTypes(List<RegisteredSubDeviceTypeDto> registeredSubDeviceTypes) {
		this.registeredSubDeviceTypes = registeredSubDeviceTypes;
	}
	...
	*//**
	...
	public List<RegisteredDeviceTypeDto> getRegisteredDeviceTypes() {
		return registeredDeviceTypes;
	}

	public void setRegisteredDeviceTypes(List<RegisteredDeviceTypeDto> registeredDeviceTypes) {
		this.registeredDeviceTypes = registeredDeviceTypes;
	}
