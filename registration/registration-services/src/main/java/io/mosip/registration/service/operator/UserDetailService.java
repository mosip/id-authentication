 ...
 * be invoked while performing automatic and manual sync operations.
 * 
...
public interface UserDetailService {
	 ...
	 * the online connectivity check will be performed to connect to the server and sync the user details.</p>
	 * 
	 * <p>If Online : </p>
	 ...
	 * 				<p>Manual trigger --> value is user id of the logged user.</p>
	 * 				<p>Batch trigger  --> value is "system"</p>
