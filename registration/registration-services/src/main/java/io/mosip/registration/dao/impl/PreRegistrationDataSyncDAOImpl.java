...
public class PreRegistrationDataSyncDAOImpl implements PreRegistrationDataSyncDAO {
	 ...
	 */
	@Autowired
	private PreRegistrationDataSyncRepository preRegistrationRepository;
	...
	public PreRegistrationList get(String preRegId) {
		...
		LOGGER.info("REGISTRATION - PRE_REGISTRATION_DATA_SYNC - PRE_REGISTRATION_DATA_SYNC_DAO_IMPL",
	...
	public List<PreRegistrationList> fetchRecordsToBeDeleted(Date startDate) {
		...
		LOGGER.info("REGISTRATION - PRE_REGISTRATION_DATA_SYNC_RECORD_FETCH - PRE_REGISTRATION_DATA_SYNC_DAO_IMPL",
				RegistrationConstants.APPLICATION_NAME, RegistrationConstants.APPLICATION_ID,
	...
	public PreRegistrationList update(PreRegistrationList preReg) {
		...
		LOGGER.info("REGISTRATION - PRE_REGISTRATION_DATA_SYNC_RECORD_UPDATE - PRE_REGISTRATION_DATA_SYNC_DAO_IMPL",
				RegistrationConstants.APPLICATION_NAME, RegistrationConstants.APPLICATION_ID,
	...
	public void deleteAll(List<PreRegistrationList> preRegistrationLists) {
		LOGGER.info("REGISTRATION - PRE_REGISTRATION_DATA_SYNC_RECORD_UPDATE - PRE_REGISTRATION_DATA_SYNC_DAO_IMPL",
				RegistrationConstants.APPLICATION_NAME, RegistrationConstants.APPLICATION_ID, "Delete records started");
		...
		LOGGER.info("REGISTRATION - PRE_REGISTRATION_DATA_SYNC_RECORD_UPDATE - PRE_REGISTRATION_DATA_SYNC_DAO_IMPL",
				RegistrationConstants.APPLICATION_NAME, RegistrationConstants.APPLICATION_ID, "delete records ended");
	...
	public Timestamp getLastPreRegPacketDownloadedTime() {
		LOGGER.info("REGISTRATION - PRE_REGISTRATION_GET_DOWNLOADED_TIME - PRE_REGISTRATION_DATA_SYNC_DAO_IMPL",
				RegistrationConstants.APPLICATION_NAME, RegistrationConstants.APPLICATION_ID, "Delete records started");
		PreRegistrationList preRegistrationList = preRegistrationRepository
