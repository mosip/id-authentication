...
public class InsertBlobContent {
	...
	public static void main(String[] args) {
		insertEmailNotificationContent();
		insertSMSNotificationContent();
	}
	...
	public static void insertAckContent() {
		try {
			...
			con = DriverManager.getConnection(
					"jdbc:derby:C:\\Users\\M1046540\\git\\Mosip_sprint4\\mosip\\registration\\registration-client\\reg;bootPassword=mosip12345",
					"", "");

			InputStream inputStream = new ByteArrayInputStream(ackContent.getBytes(Charset.forName("UTF-8")));

			pre = con.prepareStatement("update reg.template set file_txt=? where id='T01'");
	...
	public static void insertSMSNotificationContent() {
		try {
			Connection con;
			PreparedStatement pre;
			Class.forName("org.apache.derby.jdbc.EmbeddedDriver");
			...
			pre = con.prepareStatement(
					"insert into reg.Template(ID,NAME,DESCR,FILE_FORMAT_CODE,MODEL,FILE_TXT,MODULE_ID,MODULE_NAME,TEMPLATE_TYP_CODE,IS_ACTIVE,CR_BY,CR_DTIMES,LANG_CODE) values('T04','SMS Template','SMS Notification Template','SMSNotification','velocity',?,'reg','registration','SMSNotification',true,'Dinesh',CURRENT_TIMESTAMP,'eng')");
	...
	public static void insertEmailNotificationContent() {
		try {
			Connection con;
			PreparedStatement pre;
			Class.forName("org.apache.derby.jdbc.EmbeddedDriver");
			...
			pre = con.prepareStatement("insert into reg.Template(ID,NAME,DESCR,FILE_FORMAT_CODE,MODEL,"
					+ "FILE_TXT,MODULE_ID,MODULE_NAME,TEMPLATE_TYP_CODE,IS_ACTIVE,CR_BY,"
					+ "CR_DTIMES,LANG_CODE) values('T03','Email Template',"
					+ "'Email Notification Template','EmailNotification','velocity',?,"
					+ "'reg','registration','EmailNotification',true,'Dinesh',CURRENT_TIMESTAMP,"
					+ "'eng')");
