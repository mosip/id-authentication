package io.mosip.registration.service.packet.encryption.rsa.impl;

import static io.mosip.registration.constants.RegProcessorExceptionEnum.REG_BAD_PADDING_ERROR_CODE;
import static io.mosip.registration.constants.RegProcessorExceptionEnum.REG_ILLEGAL_BLOCK_SIZE_ERROR_CODE;
import static io.mosip.registration.constants.RegProcessorExceptionEnum.REG_INVALID_KEY_ERROR_CODE;
import static io.mosip.registration.constants.RegProcessorExceptionEnum.REG_NO_SUCH_ALGORITHM_ERROR_CODE;
import static io.mosip.registration.constants.RegProcessorExceptionEnum.REG_NO_SUCH_PADDING_ERROR_CODE;
...
//	private PropertyFileReader propertyFileReader;
	...
	/* (non-Javadoc)
	 * @see io.mosip.registration.manager.packet.encryption.rsa.RSAEncryption#encrypt(byte[], java.security.PublicKey)
	 */
