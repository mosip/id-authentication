...
public class MasterSyncServiceImpl implements MasterSyncService {
	 ...
	 */
	@Override
	public Map<String, Object> getMasterSync(String masterSyncDtls) throws RegBaseCheckedException {
		...
		masterSyncMap.put("registrationCntrId", registrationCenterId);
		masterSyncMap.put("lastSyncTime", lastSyncTime);
