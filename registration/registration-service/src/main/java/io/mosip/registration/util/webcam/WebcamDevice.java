...
/**
 * Interface to access the webcam device and its functionalities.
 *
...
public interface WebcamDevice {
	 ...
	 * @return Webcam returns the webcam that is set-up and opened with the specified width and
	 *         height.
	 */
	 ...
	 * 
	 * @param webcam
	 *            The on-boarded camera which is open.
