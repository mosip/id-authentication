...
public class MasterSyncJobTest {
	...
	public void executeinternalTest() throws JobExecutionException {
		...
		Mockito.when(applicationContext.getBean(MasterSyncServiceImpl.class))
				.thenReturn(masterSyncService);
	...
	public void executejobTest() {
		...
		Mockito.when(applicationContext.getBean(MasterSyncServiceImpl.class))
				.thenReturn(masterSyncService);
		// Mockito.when(JobConfigurationServiceImpl.SYNC_JOB_MAP.get(Mockito.any())).thenReturn(new
		// SyncJob());
...
//				
	...
	public void executeChildJobsTest() throws JobExecutionException {
		...
		masterSyncJob.executeChildJob("1", jobMap);
