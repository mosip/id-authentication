package io.mosip.registration.test.util.aes.impl;

import static io.mosip.registration.constants.RegConstants.AES_CIPHER_ALG;
...
public class AESDecryptionImpl implements AESDecryption {
	/* (non-Javadoc)
	 * @see io.mosip.registration.manager.aes.AESDecryption#decrypt(byte[], byte[])
	 */
	@Override	
