package org.mosip.registration.processor.service.packet.encryption.rsa.impl;

import static org.mosip.registration.processor.consts.RegProcessorExceptionEnum.REG_BAD_PADDING_ERROR_CODE;
import static org.mosip.registration.processor.consts.RegProcessorExceptionEnum.REG_ILLEGAL_BLOCK_SIZE_ERROR_CODE;
import static org.mosip.registration.processor.consts.RegProcessorExceptionEnum.REG_INVALID_KEY_ERROR_CODE;
import static org.mosip.registration.processor.consts.RegProcessorExceptionEnum.REG_NO_SUCH_ALGORITHM_ERROR_CODE;
import static org.mosip.registration.processor.consts.RegProcessorExceptionEnum.REG_NO_SUCH_PADDING_ERROR_CODE;
...
import org.mosip.registration.processor.service.packet.encryption.rsa.RSAEncryption;
...
//	private PropertyFileReader propertyFileReader;
	...
	/* (non-Javadoc)
	 * @see org.mosip.registration.processor.manager.packet.encryption.rsa.RSAEncryption#encrypt(byte[], java.security.PublicKey)
	 */
