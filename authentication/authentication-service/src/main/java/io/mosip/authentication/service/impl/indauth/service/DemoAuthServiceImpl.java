	...
	public List<MatchInput> constructMatchInput(AuthRequestDTO authRequestDTO){
		...
		if(null!=fad) {
			...
			MatchInput matchInput=new MatchInput
					(DemoMatchType.ADDR_PRI,authRequestDTO.getPersonalDataDTO().getDemoDTO().getPersonalFullAddressDTO().getMsPri(),authRequestDTO.getPersonalDataDTO().getDemoDTO().getPersonalFullAddressDTO().getMtPri());
