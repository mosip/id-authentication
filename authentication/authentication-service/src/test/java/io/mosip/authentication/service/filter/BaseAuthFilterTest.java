...
public class BaseAuthFilterTest {
	...
	@Test
	public void testConsumeRequest() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, IOException, IdAuthenticationAppException {
		...
		Mockito.when(requestWrapper.getInputStream()).thenReturn(newServletInputStream(), newServletInputStream(),newServletInputStream(),newServletInputStream(),newServletInputStream(),
				newServletInputStream(), newServletInputStream(), newServletInputStream(), newServletInputStream(), newServletInputStream());
