...
public class TemplatesTest {
	...
	private static String resultEKYCFullPri = "<html>\r\n" + 
			...
			"</head>\r\n" + 
			"<body>\r\n" + 
			"<table style=\"height: 410px; color: Black; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-bottom-color: #000000; border-left-color: #000000; border-top-color: #000000; border-right-color: #000000; border-right-style: solid; border-left-style: solid; border-bottom-style: solid; border-top-style: solid\" >\r\n" + 
			"<tbody>\r\n" + 
			"<tr style=\"height: 5px;\">\r\n" + 
