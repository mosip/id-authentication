...
import io.mosip.authentication.core.spi.idauth.demo.MatchingStrategyType;
...
public class DemoServiceTest {
	...
	public void fadMatchInputtest() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		fad.setMsPri(MatchStrategyType.PARTIAL.getType());
        ...
        listMatchInputsExp.add(new MatchInput(DemoMatchType.ADDR_PRI,MatchStrategyType.PARTIAL.getType(), 60));
	...
	public void adMatchInputtest() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        List<MatchInput> listMatchInputs=new ArrayList<>();
        List<MatchInput> listMatchInputsExp=new ArrayList<>();
        listMatchInputsExp.add(new MatchInput(DemoMatchType.ADDR_LINE1_PRI, MatchStrategyType.EXACT.getType(),100));
        listMatchInputsExp.add(new MatchInput(DemoMatchType.ADDR_LINE2_PRI, MatchStrategyType.EXACT.getType(),100));
        listMatchInputsExp.add(new MatchInput(DemoMatchType.ADDR_LINE3_PRI, MatchStrategyType.EXACT.getType(),100));
        listMatchInputsExp.add(new MatchInput(DemoMatchType.COUNTRY_PRI, MatchStrategyType.EXACT.getType(),100));
        listMatchInputsExp.add(new MatchInput(DemoMatchType.PINCODE_PRI, MatchStrategyType.EXACT.getType(),100));
	...
	public void pidMatchInputtest() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		pid.setNamePri("John");
		pid.setMsPri(MatchStrategyType.PARTIAL.getType());
        demoDTO.setPersonalIdentityDTO(pid);
        pidData.setDemoDTO(demoDTO);
        authRequestDTO.setPersonalDataDTO(pidData);
        List<MatchInput> listMatchInputs=new ArrayList<>();
        List<MatchInput> listMatchInputsExp=new ArrayList<>();
        listMatchInputsExp.add(new MatchInput(DemoMatchType.NAME_PRI, MatchStrategyType.PARTIAL.getType(),60));
        listMatchInputsExp.add(new MatchInput(DemoMatchType.AGE, MatchStrategyType.EXACT.getType(),100));
        listMatchInputsExp.add(new MatchInput(DemoMatchType.DOB, MatchStrategyType.EXACT.getType(),100));
        listMatchInputsExp.add(new MatchInput(DemoMatchType.EMAIL, MatchStrategyType.EXACT.getType(),100));
        listMatchInputsExp.add(new MatchInput(DemoMatchType.MOBILE, MatchStrategyType.EXACT.getType(),100));
        listMatchInputsExp.add(new MatchInput(DemoMatchType.GENDER, MatchStrategyType.EXACT.getType(),100));
