...
import io.mosip.authentication.service.config.AuthConfig;
...
excludeFilters={
		  @ComponentScan.Filter(type=FilterType.ASSIGNABLE_TYPE, value=AuthConfig.class)})
@EnableJpaRepositories(basePackages = { "io.mosip.kernel.keymanagerservice.repository.*" })
public class IdAuthenticationTestApplication {
