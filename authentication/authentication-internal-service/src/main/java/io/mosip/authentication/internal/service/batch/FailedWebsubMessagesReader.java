 ...
 */
@Component
public class FailedWebsubMessagesReader implements ItemReader<Object> {
	...
	private Iterator<Object> messagesIterator;
	...
	private void initialize() {
		...
		messagesIterator = getRequestIdsIterator();
	}
	 ...
	 */
	private Iterator<Object> getRequestIdsIterator() {
		Stream<Object> requestIdStream = Stream
	 ...
	 */
	private List<Object> getNextPageItems() {
		try {
