...
public class CredentialIssueanceCallbackController {
	...
	@PreAuthenticateContentAndVerifyIntent(secret = "test",callback = "/idauthentication/v1/internal/callback/idchange/credential_issued/mpartner-default-auth" ,topic = "mpartner-default-auth/CREDENTIAL_ISSUED")
