...
@Import(value = { IdValidationUtil.class, IDAMappingConfig.class, KeyManager.class, RestHelperImpl.class,
		...
		BioProviderImpl_V_0_8.class, BioProviderImpl_V_0_9.class, BioProviderImpl_V_1_2.class, OTPServiceImpl.class,
		...
		IdAuthFraudAnalysisEventPublisher.class, MosipAuthFilterFactory.class })
