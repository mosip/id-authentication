package io.mosip.authentication.common.service.impl.indauth.service.demo;
...
public class DemoMatchTypeTest {
	...
	public void TestFullAddress() {
		...
		// FIXME fix this
		// assertEquals(tmpAddress, DemoMatchType.ADDR_SEC.getEntityInfo(demoEntity,
		// languageCodeFetcher,
	...
	// Mockito.mock(LocationInfoFetcher.class);
	//
	// Mockito.when(locationInfoFetcher.getLocation(LocationLevel.CITY,
	// demoEntity.getLocationCode()))
	// .thenReturn(Optional.of("chennai"));
	// Mockito.when(locationInfoFetcher.getLocation(LocationLevel.COUNTRY,
	// demoEntity.getLocationCode()))
	// .thenReturn(Optional.of("india"));
	// Mockito.when(locationInfoFetcher.getLocation(LocationLevel.ZIPCODE,
	// demoEntity.getLocationCode()))
	// .thenReturn(Optional.of("600111"));
	// assertEquals(tmpAddress,
	...
	public void TestDOBMatchStrategy() throws ParseException {
		...
		// DemoMatchType.DOB.getEntityInfoFetcher().getInfo(demoEntity,
		// null).toString());
	}
	...
	public void TestCityStrategy() {
		...
		// DemoMatchType.CITY_PRI.getEntityInfoFetcher().getInfo(demoEntity,
		// locationInfoFetcher));
	}
	...
	public void TestStateStrategy() {
		...
		// Mockito.mock(LocationInfoFetcher.class);
		//
		// Mockito.when(locationInfoFetcher.getLocation(LocationLevel.STATE,
		// demoEntity.getLocationCode()))
		// .thenReturn(Optional.of("TamilNadu"));
		// assertEquals(DemoMatchType.STATE_PRI.getDemoInfoFetcher().apply(demoDTO).get(),
		// DemoMatchType.STATE_PRI.getEntityInfoFetcher().getInfo(demoEntity,
		// locationInfoFetcher));
	}
