...
import io.mosip.authentication.common.service.impl.match.IrisMatchingStrategy;
...
public class IrirsMatchingStrategyTest {
	...
	/**
	 * Check for Exact type not matched with Enum value of IrisMatchingStrategy Matching Strategy
	 */
	@Test
