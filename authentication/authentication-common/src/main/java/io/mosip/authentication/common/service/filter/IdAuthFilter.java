...
public class IdAuthFilter extends BaseAuthFilter {
	...
	private Map<String, Object> decipherBioData(Object obj, int index) throws IdAuthenticationAppException {
		...
		try {
			...
			String decryptedData = keyManager.kernelDecrypt(String.valueOf(thumbprint), CryptoUtil.decodeBase64Plain(String.valueOf(sessionKey)), CryptoUtil.decodeBase64Plain(String.valueOf(bioValue)), getBioRefId(),
