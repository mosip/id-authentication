...
public class IdaTransactionInterceptor extends EmptyInterceptor {
	...
	public void idaTransactionInterceptor() {
		System.err.println("IDA*******Tranaction interceptor");
	}
	...
	public boolean onSave(Object entity, Serializable id, Object[] state, String[] propertyNames, Type[] types) {
		try {
			if (entity instanceof AutnTxn) {
				...
				String encryptedUinWithSalt = uinList.get(0) + IdAuthCommonConstants.UIN_MODULO_SPLITTER + new String(encryptedUinByteWithSalt);
