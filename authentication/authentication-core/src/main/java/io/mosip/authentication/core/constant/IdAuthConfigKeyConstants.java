...
public final class IdAuthConfigKeyConstants {
	...
	public static final String PREFERRED_LANG_ATTRIB = "mosip.default.user-preferred-language-attribute";
	public static final String LOCATION_PROFILE_ATTRIB = "mosip.location.profile.attribute";
