...
public interface AuthFacade {
	 ...
	 */
	AuthResponseDTO authenticateIndividual(AuthRequestDTO authRequest, boolean isAuth,String partnerId, String partnerApiKey, boolean markVidConsumed, ObjectWithMetadata requestWithMetadata)
