...
import static io.mosip.authentication.core.constant.IdAuthConfigKeyConstants.IDA_MOSIP_KYC_AUTH_FILTER_CLASSES_IN_EXECUTION_ORDER;
...
@Configuration
public class KycAuthFilterFactory extends MosipAuthFilterFactory {
	
	/** The mosip auth filter classes. */
	@Value("${" + IDA_MOSIP_KYC_AUTH_FILTER_CLASSES_IN_EXECUTION_ORDER + "}")
