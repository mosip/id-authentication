...
@Import(value = { IdValidationUtil.class, IDAMappingConfig.class, KeyManager.class, RestHelperImpl.class,
		...
		SwaggerConfig.class, AuditHelper.class, IdAuthExceptionHandler.class, AuthRequestValidator.class, PinValidatorImpl.class,
		BioMatcherUtil.class, BioAPIFactory.class, BioProviderImpl_V_0_8.class, BioProviderImpl_V_0_9.class,
		BioProviderImpl_V_1_2.class, IdAuthSecurityManager.class, AuthtypeStatusImpl.class, CryptoCore.class,
		...
		KeymanagerDBHelper.class, IdTypeUtil.class, MasterDataCache.class, MasterDataCacheInitializer.class,
		...
		MasterDataUpdateEventInitializer.class, DemoMatcherUtil.class, DemoNormalizer.class,
		IdAuthFraudAnalysisEventManager.class, IdAuthFraudAnalysisEventPublisher.class, MosipAuthFilterFactory.class })
