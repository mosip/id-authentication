...
@Import(value = { UinValidatorImpl.class, VidValidatorImpl.class, IDAMappingConfig.class, KeyManager.class,
		...
		BioMatcherUtil.class, BioAPIFactory.class, BioProviderImpl_V_0_8.class, BioProviderImpl_V_0_9.class, BioProviderImpl_V_1_2.class,
		...
		RetryAspect.class, AuthTransactionHelper.class, HotlistServiceImpl.class, AuthTransactionStatusEventPublisher.class })
