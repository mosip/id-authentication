...
public class DeviceProviderHotlistFilterImplTest {
	...
	@Before
	public void before() {
		ReflectionTestUtils.setField(deviceProviderHotlistFilterImpl, "hotlistService", hotlistService);
	}

	@Test
	public void testInit() throws IdAuthenticationFilterException {
		deviceProviderHotlistFilterImpl.init();
		// No exception should be thrown
	}

	@Test
	public void testValidateWithNonHotlistedProvider() throws IdAuthenticationFilterException {
		...
		String providerInfo = "DP1" + "DPID1";
		String hash = IdAuthSecurityManager.generateHashAndDigestAsPlainText(providerInfo.getBytes());

		deviceProviderHotlistFilterImpl.validate(authRequest, identityData, properties);
	}
