package io.mosip.internal.authentication.service;
...
@Import(value = { HibernateDaoConfig.class, UinValidatorImpl.class, VidValidatorImpl.class, IDAMappingConfig.class,
		...
		BiometricProviderFactory.class, OTPManager.class,   MasterDataManager.class,
		MatchInputBuilder.class,  IdRepoManager.class,
		NotificationManager.class, NotificationServiceImpl.class, IdTemplateManager.class,
		TemplateManagerBuilderImpl.class, IdAuthExceptionHandler.class,AuthFacadeImpl.class })
