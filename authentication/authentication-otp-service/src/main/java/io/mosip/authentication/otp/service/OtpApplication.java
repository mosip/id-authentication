...
@Import(value = {IdValidationUtil.class, IDAMappingConfig.class, KeyBindedTokenAuthServiceImpl.class,
		...
		LangComparatorConfig.class, OpenApiProperties.class, SessionKeyDecryptorHelper.class, ExternalRestHelperConfig.class, IdaRequestResponsConsumerUtil.class,
		...
		SubscriberClientImpl.class, RestTemplate.class, ECKeyPairGenRequestValidator.class, TrailingSlashRedirectFilter.class, SubjectAlternativeNamesHelper.class, SignatureServiceImpl.class, SignatureUtil.class})
