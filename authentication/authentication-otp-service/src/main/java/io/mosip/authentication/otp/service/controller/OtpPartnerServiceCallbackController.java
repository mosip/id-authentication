...
/**
 * The Class OtpPartnerServiceCallbackController.
 */
@RestController
public class OtpPartnerServiceCallbackController {
	...
	@PreAuthenticateContentAndVerifyIntent(secret = "${" + IDA_WEBSUB_PARTNER_SERVICE_CALLBACK_SECRET
			+ "}", callback = "/idauthentication/v1/otp/callback/partnerServiceCallback", topic = "${ida-topic-partner-service-update}")
