...
-- Revert column renaming and type changes on BATCH_JOB_EXECUTION_PARAMS
ALTER TABLE BATCH_JOB_EXECUTION_PARAMS ALTER COLUMN PARAMETER_TYPE TYPE VARCHAR(6); -- Revert back the type change
...
-- Drop the sequences if they were created
