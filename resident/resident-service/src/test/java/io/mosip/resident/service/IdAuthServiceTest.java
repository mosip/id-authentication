...
public class IdAuthServiceTest {
	...
	public void testAuthTypeStatusUpdateFailure() throws ApisResourceAccessException, ResidentServiceCheckedException {
		...
		when(restClient.postApi(any(), any(), any(), any(), any()))
	...
	public void otpValidationFailedTest() throws IOException, ApisResourceAccessException, OtpValidationFailedException {
		String transactionID = "12345";
		String individualId = "individual";
		String individualIdType = IdType.UIN.name();
		String otp = "12345";
		...
		when(restClient.postApi(any(), any(), any(), any(Class.class), any())).thenThrow(new ApisResourceAccessException());
