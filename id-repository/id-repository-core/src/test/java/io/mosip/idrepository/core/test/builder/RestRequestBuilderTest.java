...
public class RestRequestBuilderTest {
	...
	public void testBuildRequestWithMultiValueMap() throws IdRepoDataValidationException {
		...
		environment.setProperty("mosip.idrepo.identity.audit.rest.headers.mediaType", "multipart/form-data");
		environment.setProperty("mosip.idrepo.identity.audit.rest.uri.queryparam.test", "yes");
		environment.setProperty("mosip.idrepo.identity.audit.rest.uri.pathparam.test", "yes");
	...
	public void testBuildRequestEmptyUri() throws IdRepoDataValidationException {
		...
		MockEnvironment environment = new MockEnvironment();
		environment.merge(env);
		environment.setProperty("mosip.idrepo.identity.audit.rest.uri", "");
	...
	public void testBuildRequestEmptyHttpMethod() throws IdRepoDataValidationException {
		...
		MockEnvironment environment = new MockEnvironment();
		environment.merge(env);
		environment.setProperty("mosip.idrepo.identity.audit.rest.httpMethod", "");
	...
	public void testBuildRequestEmptyTimeout() throws IdRepoDataValidationException {
		...
		MockEnvironment environment = new MockEnvironment();
		environment.merge(env);
		environment.setProperty("mosip.idrepo.identity.audit.rest.timeout", "");
	...
	public void testBuildRequestHeaders() throws IdRepoDataValidationException {
		...
		MockEnvironment environment = new MockEnvironment();
		environment.merge(env);
		environment.setProperty("mosip.idrepo.identity.audit.rest.headers.accept", "application/json");
