...
public class AuditRequestBuilderTest {
	...
	public void testBuildRequest() {
		...
		try {
			...
			expectedRequest.setApplicationId(env.getProperty("mosip.idrepo.identity.application.id"));
			expectedRequest.setApplicationName(env.getProperty("mosip.idrepo.identity.application.name"));
