...
/**
 * Test Class to perform Create new pre-registration related Positive and Negative test cases
 * 
 * @author Ashish Rastogi
 * @since 1.0.0
 */

public class CreatePreRegistrationTest extends BaseTestCase implements ITest{
	...
	private static Logger logger = Logger.getLogger(CreatePreRegistrationTest.class);
	...
	/*
	 * Given Create PreRegistration valid request when I Send POST request to /demographic/v0.1/pre-registration/applications
	 * Then I should get success response with elements defined as per specifications
	 * Given Invalid request when I send POST request to /demographic/v0.1/pre-registration/applications
    ...
    public void setResultTestName(ITestResult result) {
          try {
                ...
                f.set(baseTestMethod, CreatePreRegistrationTest.testCaseName);
          } catch (Exception e) {
