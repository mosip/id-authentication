...
public class DeleteAllDocumentsByPreRegIDTest extends BaseTestCase implements ITest {
	...
	private static Logger logger = Logger.getLogger(DeleteAllDocumentsByPreRegIDTest.class);
	...
	public DeleteAllDocumentsByPreRegIDTest() {
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, DeleteAllDocumentsByPreRegIDTest.testCaseName);
		} catch (Exception e) {
