...
public class CreateUIN extends IdRepoTestsUtil implements ITest {
	...
	public void storeUinData() {
		...
		generateMappingDic(new File(RunConfigUtil.getResourcePath() + RunConfigUtil.objRunConfig.getTestDataFolderName()+"/" + RunConfigUtil.objRunConfig.getTestDataFolderName()
