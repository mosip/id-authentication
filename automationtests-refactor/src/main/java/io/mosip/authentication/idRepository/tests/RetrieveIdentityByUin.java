 ...
 *
 */
public class RetrieveIdentityByUin extends IdRepoTestsUtil implements ITest {

	private static final Logger logger = Logger.getLogger(RetrieveIdentityByUin.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, RetrieveIdentityByUin.testCaseName);
		} catch (Exception e) {
	...
	public void RetrieveUIN(TestParameters objTestParameters, String testScenario,
			String testcaseName) {
