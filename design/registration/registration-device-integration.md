...
The key **non-functional requirements** are
     -     Modularity: 
             -  Separate Api and the respective façade should be provide to the client application to interact with the devices.
             -  Device related code shouldn’t be implemented inside the functional specific controller or service class.
 ...
 **Solution - Finger Print**
     ...
     FingerprintValidator – It does validation of finger print minutia.
