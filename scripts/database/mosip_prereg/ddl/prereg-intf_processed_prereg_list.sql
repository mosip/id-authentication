...
-- ddl-end --
COMMENT ON TABLE prereg.intf_processed_prereg_list IS 'Table to store all the pre-registration list received from registration processor within pre-registration module';
-- ddl-end --
...
-- ddl-end --
COMMENT ON COLUMN prereg.intf_processed_prereg_list.received_dtimes IS 'Datetime when the pre-registration id was recevied';
-- ddl-end --
