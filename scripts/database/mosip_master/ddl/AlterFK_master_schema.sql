...
alter table master.app_authentication_method add constraint fk_appauthm_appdtl foreign key (app_id, lang_code) references master.app_detail(id, lang_code) on delete no action on update no action ;
...
alter table master.app_role_priority add constraint fk_roleprt_appdtl foreign key (app_id, lang_code) references master.app_detail(id, lang_code) on delete no action on update no action ;
...
alter table master.reg_center_machine add constraint fk_cntrmac_regcntr foreign key (regcntr_id, lang_code) references master.registration_center(id, lang_code) on delete no action on update no action ;
alter table master.reg_center_machine add constraint fk_cntrmac_machm foreign key (machine_id, lang_code) references master.machine_master(id, lang_code) on delete no action on update no action ;
...
alter table master.reg_center_user_machine add constraint fk_cntrmusr_regcntr foreign key (regcntr_id, lang_code) references master.registration_center(id, lang_code) on delete no action on update no action ;
...
alter table master.reg_center_user_machine add constraint fk_cntrmusr_machm foreign key (machine_id, lang_code) references master.machine_master(id, lang_code) on delete no action on update no action ;

alter table master.reg_center_machine_device add constraint fk_cntrmdev_regcntr foreign key (regcntr_id, lang_code) references master.registration_center(id, lang_code) on delete no action on update no action ;
alter table master.reg_center_machine_device add constraint fk_cntrmdev_machm foreign key (machine_id, lang_code) references master.machine_master(id, lang_code) on delete no action on update no action ;
alter table master.reg_center_machine_device add constraint fk_cntrmdev_devicem foreign key (device_id, lang_code) references master.device_master(id, lang_code) on delete no action on update no action ;

alter table master.reg_center_user add constraint fk_cntrusr_regcntr foreign key (regcntr_id, lang_code) references master.registration_center(id, lang_code) on delete no action on update no action ;
...
alter table master.screen_authorization add constraint fk_scrauth_scrdtl foreign key (screen_id, lang_code) references master.screen_detail(id, lang_code) on delete no action on update no action ;
...
alter table master.screen_detail add constraint fk_scrdtl_appdtl foreign key (app_id, lang_code) references master.app_detail(id, lang_code) on delete no action on update no action ;
...
alter table master.template add constraint fk_tmplt_moddtl foreign key (module_id, lang_code) references master.module_detail(id, lang_code) on delete no action on update no action ;
...
alter table master.applicant_valid_document add constraint fk_avaldoc_doctyp foreign key (doctyp_code, lang_code) references master.doc_type(code, lang_code) on delete no action on update no action ;
alter table master.applicant_valid_document add constraint fk_avaldoc_doccat foreign key (doccat_code, lang_code) references master.doc_category(code, lang_code) on delete no action on update no action ;
