...
-- table 		: doc_category  - Master doc_category list
-- table alias  : doccat	
...
-- indexes section -----------------------------------------------------------------------
-- create index idx_doccat_<col> on master.doc_category (col)
-- ;

-- comments section -------------------------------------------------------------------------- 
comment on table master.doc_category is 'Master doc_category table'
;
