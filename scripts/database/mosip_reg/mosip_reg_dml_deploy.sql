...
insert into reg.global_param values ('mosip.kernel.keygenerator.asymmetric-algorithm-length','mosip.kernel.keygenerator.asymmetric-algorithm-length','2048','CONFIGURATION','eng',true,'SYSTEM',current timestamp, 'SYSTEM',current timestamp, false, current timestamp);
...
insert into reg.global_param values ('mosip.registration.initial_setup','mosip.registration.initial_setup','false','CONFIGURATION','eng',true,'System',current timestamp,'SYSTEM',current timestamp, false, current timestamp); 

insert into reg.global_param values ('mosip.reg.db.current.version','mosip.reg.db.current.version','0','CONFIGURATION','eng',true,'SYSTEM',current timestamp, 'SYSTEM',current timestamp, false, current timestamp);
