...
public enum TitleErrorCode {
	...
	TITLE_FETCH_EXCEPTION("KER-MSD-047", "Error occured while fetching Titles"), TITLE_NOT_FOUND("KER-MSD-048",
			"Title not found"), TITLE_INSERT_EXCEPTION("KER-MSD-XXX",
					"Error occurred while inserting Title details	"), TITLE_UPDATE_EXCEPTION("KER-MSD-103",
							"Error occurred while updating Title details"), TITLE_DELETE_EXCEPTION("KER-MSD-104",
