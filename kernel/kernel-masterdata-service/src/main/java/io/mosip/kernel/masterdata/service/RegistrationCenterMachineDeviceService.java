...
public interface RegistrationCenterMachineDeviceService {
	 ...
	 * database.
	 * 
	 * @param requestDto contains {@link RegistrationCenterMachineDeviceDto} which
	 *                   must contains registration center id, machine id and device
	 *                   id.
	 * 
	 ...
	 *                                    registration center id, machine id and
	 *                                    device id. Like if registration center id,
	 *                                    machine id or device id is not valid or
	 *                                    not present in database.
	 * 
	 */
	public ResponseRegistrationCenterMachineDeviceDto createRegistrationCenterMachineAndDevice(
			RegistrationCenterMachineDeviceDto requestDto);
