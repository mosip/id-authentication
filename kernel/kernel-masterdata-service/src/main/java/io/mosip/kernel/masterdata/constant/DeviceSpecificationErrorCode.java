...
public enum DeviceSpecificationErrorCode {
	...
	DEVICE_SPECIFICATION_UPDATE_EXCEPTION("KER-MSD-XXX","Error occured while Device Specification"), 
	DEVICE_SPECIFICATION_DELETE_EXCEPTION("KER-MSD-XXX", "Error occured while Device Specification");
