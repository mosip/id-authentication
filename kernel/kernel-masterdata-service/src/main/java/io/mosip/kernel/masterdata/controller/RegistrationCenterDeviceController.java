...
public class RegistrationCenterDeviceController {
	...
	public ResponseWrapper<DeviceAndRegCenterMappingResponseDto> unmapDeviceRegCenter(
		...
		auditUtil.auditRequest(MasterDataConstant.UNMAP_API_IS_CALLED + RegistrationCenterDeviceDto.class.getCanonicalName(),
				MasterDataConstant.AUDIT_SYSTEM,
				MasterDataConstant.UNMAP_API_IS_CALLED + RegistrationCenterDeviceDto.class.getCanonicalName(),"ADM-729");
		...
		auditUtil.auditRequest(
				String.format(MasterDataConstant.SUCCESSFUL_UNMAP, RegistrationCenterDeviceDto.class.getCanonicalName()),
				MasterDataConstant.AUDIT_SYSTEM,
				String.format(MasterDataConstant.SUCCESSFUL_UNMAP, RegistrationCenterDeviceDto.class.getCanonicalName()),"ADM-730");
		return responseWrapper;
	}
	...
	public ResponseWrapper<ResponseDto> mapRegistrationCenterDevice(
		...
		auditUtil.auditRequest(MasterDataConstant.MAP_API_IS_CALLED + RegistrationCenterDeviceDto.class.getCanonicalName(),
				MasterDataConstant.AUDIT_SYSTEM,
		...
		auditUtil.auditRequest(
				...
				MasterDataConstant.AUDIT_SYSTEM,
				String.format(MasterDataConstant.SUCCESSFUL_MAP, RegistrationCenterDeviceDto.class.getCanonicalName()),"ADM-728");
		return responseWrapper;
	}
}
