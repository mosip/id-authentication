...
public interface RegistrationCenterMachineDeviceRepository
	...
	@Query("FROM RegistrationCenterMachineDevice rcm where rcm.registrationCenterMachineDevicePk.regCenterId = ?1 AND rcm.registrationCenterMachineDevicePk.machineId = ?2 AND rcm.registrationCenterMachineDevicePk.deviceId = ?3 AND (rcm.IsDeleted is null or IsDeleted=false)")
