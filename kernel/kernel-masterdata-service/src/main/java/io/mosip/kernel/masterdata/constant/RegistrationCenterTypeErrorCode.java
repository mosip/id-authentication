...
public enum RegistrationCenterTypeErrorCode {
	REGISTRATION_CENTER_TYPE_FETCH_EXCEPTION("KER-MSD-013",
			"Error occurred while fetching Registration Center Type details"),
	REGISTRATION_CENTER_TYPE_INSERT_EXCEPTION("KER-MSD-050",
			"Error occurred while inserting Registration Center Type details"),
	REGISTRATION_CENTER_TYPE_NOT_FOUND_EXCEPTION("KER-MSD-120", "Registration Center Type not found"),
	REGISTRATION_CENTER_TYPE_UPDATE_EXCEPTION("KER-MSD-109",
