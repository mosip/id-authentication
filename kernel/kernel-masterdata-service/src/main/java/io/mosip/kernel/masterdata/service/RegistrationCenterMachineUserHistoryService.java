...
public interface RegistrationCenterMachineUserHistoryService {
	 ...
	 * @param effectiveTimestamp   effective time stamp provided by user
	 * @param registrationCenterId registration center id provided by user
	 * @param machineId            machine id provided by user
	 * @return {@link RegistrationCenterUserMachineMappingHistoryResponseDto}
	 *         response
	 */
	public RegistrationCenterUserMachineMappingHistoryResponseDto getRegistrationCentersMachineUserMapping(
			String langCode, String effectiveTimestamp, String registrationCenterId, String machineId);
