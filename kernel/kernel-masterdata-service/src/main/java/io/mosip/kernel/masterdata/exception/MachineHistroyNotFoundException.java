 ...
 * @since 1.0.0
 */
public class MachineHistroyNotFoundException extends BaseUncheckedException {
	 ...
	 *            exception message
	 */
	public MachineHistroyNotFoundException(String errorCode, String errorMessage) {
