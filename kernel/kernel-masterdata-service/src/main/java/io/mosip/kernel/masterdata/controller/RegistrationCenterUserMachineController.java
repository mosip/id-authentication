...
public class RegistrationCenterUserMachineController {
	...
	@DeleteMapping("/{regCenterId}/{machineId}/{userId}")
	public ResponseEntity<RegistrationCenterMachineUserID> deleteRegistrationCenterUserMachineMapping(
			...
			@ApiParam("Machine id to be deleted") @PathVariable String machineId,@ApiParam("User id to be deleted") @PathVariable String userId) {
		return new ResponseEntity<>(
				registrationCenterMachineUserService.deleteRegistrationCentersMachineUserMapping(regCenterId, machineId, userId),
				HttpStatus.OK);
	}
