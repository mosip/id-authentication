...
public class DeviceServiceImplTest {
	...
	public void testGetMachineDetailAllThrowsDataAccessExcetion() {
		Mockito.when(deviceRepository.findByLangCode(Mockito.anyString())).thenThrow(DataRetrievalFailureException.class);
		deviceServiceImpl.getDeviceLangCode("ENG");
	...
	public void testGetDeviceLangCodeAndDeviceType() {
		...
		Mockito.when(deviceRepository.findByLangCodeAndDtypeCode(Mockito.anyString(), Mockito.anyString())).thenReturn(objectList);
	...
	public void testGetDeviceLangCodeAndDeviceTypeThrowsDataAccessExcetion() {
		Mockito.when(deviceRepository.findByLangCodeAndDtypeCode(Mockito.anyString(), Mockito.anyString())).thenThrow(DataRetrievalFailureException.class);
		deviceServiceImpl.getDeviceLangCodeAndDeviceType("ENG","laptop_code");
