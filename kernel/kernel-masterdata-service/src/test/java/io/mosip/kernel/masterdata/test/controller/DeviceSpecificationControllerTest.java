...
public class DeviceSpecificationControllerTest {
	...
	public void testGetDeviceSpecificationByLanguageCode() {			
		Mockito.when(deviceSpecificationService.findDeviceSpecificationByLangugeCode("ENG")).thenReturn(deviceSpecificationDtoList);
		DeviceSpecificationResponseDto actual = deviceSpecificationController.getDeviceSpecificationByLanguageCode("ENG");
	...
	public void testGetDeviceSpecificationByLanguageCodeAndDeviceTypeCode() {	
		...
		Mockito.when(deviceSpecificationService.findDeviceSpecificationByLangugeCodeAndDeviceTypeCode(Mockito.anyString(), Mockito.anyString())).thenReturn(deviceSpecificationDtoList);
		DeviceSpecificationResponseDto actual = deviceSpecificationController.getDeviceSpecificationByLanguageCodeAndDeviceTypeCode("ENG", "operating_sys");
