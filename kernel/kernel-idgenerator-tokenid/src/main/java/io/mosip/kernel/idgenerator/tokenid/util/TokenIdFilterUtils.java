...
public class TokenIdFilterUtils {
	...
	/**
	 * Checks if the input id is valid by passing the id through SEQUENCE_LIMIT
	 * filter, #REPEATING_LIMIT filter and REPEATING_BLOCK_LIMIT filters
	 * 
	 * @param id
	...
	/**
	 * Checks the input id for sequenceLimit filter
	 * 
	 * @param id
	 *            The input id to validate
