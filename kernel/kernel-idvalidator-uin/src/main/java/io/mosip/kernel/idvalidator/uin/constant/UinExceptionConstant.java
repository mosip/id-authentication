...
public enum UinExceptionConstant {
	...
	UIN_VAL_ILLEGAL_SEQUENCE_REPEATATIVE("KER-IDV-202", "UIN should not contain any sequential and repeated block of number as per configured or more than that digits and Admin ristricted numbers"), 
	...
	UIN_VAL_ILLEGAL_REVERSE("KER-IDV-207", "UIN First configured no.of digits should be different from the reverse of last configured no. of digits"),
	UIN_VAL_ILLEGAL_EQUAL_LIMIT("KER-IDV-208", "UIN First configured no.of digits should be different from the last configured no.of digits");
	/**
