...
/**
 * This class is used to test the functionality of EID Generator
...
public class App 
{
    ...
    public static void main( String[] args ) throws MosipNullValueException, MosipEmptyInputException, MosipInputLengthException
    {
    	EidGenerator eidGen=new EidGenerator();
		...
		System.out.println(eidGen.eidGeneration(var1, var2));
		/*System.out.println("Current DateTime="+foramttedString);
		Random rnd = new Random();
        int n = 10000 + rnd.nextInt(90000);
        SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMddHHmmss");  
        Date date = new Date();  
       String currTimestamp=formatter.format(date);  
       eid=agent1+machine1+n+currTimestamp;
       //System.out.println(eid);
*/    }
}
