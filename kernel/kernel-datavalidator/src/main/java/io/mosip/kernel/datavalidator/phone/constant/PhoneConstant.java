...
public enum PhoneConstant {
	...
	PHONE_NUM_INVALID_NULL("KER-MOV-001", "Phone number should not be empty or null."),
	PHONE_NUM_INVALID_MIN_MAX_LENGTH("KER-MOV-002", "Phone number length should be specified number of digits."),
	PHONE_NUM_INVALID_DIGITS("KER-MOV-003",
