...
public enum IdObjectValidatorConstant {
	...
	IDENTITY_LOCALADMINISTRATIVEAUTHORITY_LANGUAGE_PATH("identity.localAdministrativeAuthority.*.language"),
	IDENTITY_LOCALADMINISTRATIVEAUTHORITY_VALUE_PATH("identity.localAdministrativeAuthority.*.value"),
