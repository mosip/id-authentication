...
import io.mosip.kernel.jsonvalidator.impl.IdObjectCompositeValidator;
import io.mosip.kernel.jsonvalidator.impl.IdObjectMasterDataValidator;
import io.mosip.kernel.jsonvalidator.impl.IdObjectPatternValidator;
...
public class IdObjectValidatorTest {
	...
	@Before
	public void setup() {
		ReflectionTestUtils.setField(masterDataValidator, "languageList", Collections.singletonList("eng"));
		ReflectionTestUtils.setField(masterDataValidator, "genderMap", new LinkedMultiValueMap<>(Collections.singletonMap("eng", Collections.singletonList("male"))));
		ReflectionTestUtils.setField(masterDataValidator, "docCatMap", new LinkedMultiValueMap<>(Collections.singletonMap("eng", Collections.singletonList("POA"))));
		ReflectionTestUtils.setField(masterDataValidator, "docTypeMap", new LinkedMultiValueMap<>(Collections.singletonMap("POA", Collections.singletonList("Passport"))));
		...
		regionMapping.add("eng", "Tanger-Tétouan-Al Hoceima");
		...
		provinceMapping.add("eng", "Tanger-Tétouan-Al Hoceima");
		...
		pcMapping.add("eng", "Tanger-Tétouan-Al Hoceima");
