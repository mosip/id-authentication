...
public interface RegistrationCenterMachineHistoryRepository
	...
	List<RegistrationCenterMachineHistory> findLatestRegistrationCenterMachineHistory(String regId,LocalDateTime lastUpdated,LocalDateTime currentTimeStamp);
}
