...
public interface RegistrationCenterUserHistoryRepository
		extends BaseRepository<RegistrationCenterUserHistory, RegistrationCenterUserHistoryID> {
	...
	List<RegistrationCenterUserHistory> findLatestRegistrationCenterUserHistory(String regId,
