...
public enum PridExceptionConstant {
	PRID_FETCH_EXCEPTION("KER-PRID-001","Error occur while fetching counter and value details"),
	PRID_INSERTION_EXCEPTION("KER-PRID-002","Error occur while updating counter details");
