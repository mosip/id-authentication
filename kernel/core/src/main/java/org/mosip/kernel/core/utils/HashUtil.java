...
import org.mosip.kernel.core.utils.constants.HashUtilConstants;
...
public class HashUtil {
	 ...
	 */
	public HashUtil(final long initialOddNumber, final long multiplierOddNumber) throws MosipHashUtilException {
	 ...
	 * @return this
	 */
	public HashUtil append(boolean value) {
	 ...
	 * @return this
	 */
	public HashUtil append(boolean[] array) {
		if (array == null) {
	 ...
	 * @return this
	 */
	public HashUtil append(byte value) {
	 ...
	 * @return this
	 */
	public HashUtil append(byte[] array) {
		if (array == null) {
			total = total * multiplierConstant;
        } else {
	 ...
	 * @return this
	 */
	public HashUtil append(char value) {
		total = total * multiplierConstant +(long) value;
		return this;
	}
	 ...
	 * @return this
	 */
	public HashUtil append(char[] array) {
		if (array == null) {
			total = total * multiplierConstant;
        } else {
	 ...
	 * @return this
	 */
	public HashUtil append(double value) {
	 ...
	 * @return this
	 */
	public HashUtil append(double[] array) {
		 if (array == null) {
			 total = total * multiplierConstant;
	        } else {
	 ...
	 * @return this
	 */
	public HashUtil append(float value) {
	 ...
	 * @return this
	 */
	public HashUtil append(float[] array) {
		 if (array == null) {
			 total = total * multiplierConstant;
	        } else {
	 ...
	 * @return this
	 */
	public HashUtil append(int value) {
		total = total * multiplierConstant +(long) value;
		return this;
	}
	 ...
	 * @return this
	 */
	public HashUtil append(int[] array) {
		if (array == null) {
			total = total * multiplierConstant;
        } else {
	 ...
	 * @return this
	 */
	public HashUtil append(long value) {
	 ...
	 * @return this
	 */
	public HashUtil append(long[] array) {
		if (array == null) {
			total = total * multiplierConstant;
        } else {
	 ...
	 * @return this
	 */
	public HashUtil append(Object value) {
		if (value == null) {
			total = total * multiplierConstant;
	 ...
	 * @return this
	 */
	public HashUtil append(Object[] array) {
		if (array == null) {
			total = total * multiplierConstant;
        } else {
	 ...
	 * @return this
	 */
	public HashUtil append(short value) {
		total = total * multiplierConstant +(long) value;
		return this;
	}
	 ...
	 * @return this
	 */
	public HashUtil append(short[] array) {
		if (array == null) {
			total = total * multiplierConstant;
        } else {
