...
import org.mosip.kernel.core.utils.HashUtil;
import org.mosip.kernel.core.utils.exception.MosipHashUtilException;
/**
	...
	public void testBuild() throws MosipHashUtilException {
		...
		assertEquals(((((((((7919l*7664345821815920749L)+34)*7664345821815920749L)*7664345821815920749L)+1)*
				...
				*7664345821815920749L)+Arrays.asList("Ramesh","Suresh").hashCode(), 
				new HashUtil().append(34).append(obj).append(false).append(12.3).append(Arrays.
						asList("Ramesh","Suresh")).build());
		
		assertEquals((((((((((23l*45)+123456789000l)*45)+ 
				Float.floatToIntBits(2.453f))*45)+ sh)*45)+ b)*45)+(long) 'r', 
				new HashUtil(23,45).append(123456789000l).append(2.453f).append(sh).append(b).append('r').build());
		
		assertEquals(23l*45*45*45*45,
				new HashUtil(23, 45).append(str).append(int1).
				append(bool1).append(dob).build());
		
		assertEquals(23l*45*45*45*45*45,
				new HashUtil(23,45).append(byt).append(sho).append(lon).append(flo).append(chr).build());
		...
		Object obj9=new char[] {'r','e'};
		 ...
		 assertEquals(((((((((((23l*45)+34)*45)+(long)'R')*45)+(long)'a')*45)+(long)'m')*45+1)*45)+Double.
				 doubleToLongBits(12.3) , 
					new HashUtil(23, 45).append(34).append("Ram").append(false).append(12.3).toHashCode());
						
			assertEquals((((((((((23l*45)+123456789000l)*45)+ 
					Float.floatToIntBits(2.453f))*45)+ sh)*45)+ b)*45)+(long) 'r', 
					new HashUtil(23,45).append(123456789000l).append(2.453f).append(sh).append(b).append('r').
					toHashCode());
			...
			assertEquals(((((((((((((((((((((23l*45)+(long)'R')*45)+(long)'a')*45)+(long)'s')*45)+(long)'h')*45+
					...
					new HashUtil(23, 45).append(new String[] {"Ra","sh"}).append(new int[] {23,46,74}).
					append(new boolean[] {true,false}).append(new double[] {12.3,45.7}).toHashCode());
			
			assertEquals((((((((((((((((((((((23l*45)+(long)'R')*45)+(long)'a')*45)+(long)'s')*45)+(long)'h')*45)
					+23)*45)+46)*45)+74)*45)+0)*45)+1)*45)+Double.doubleToLongBits(12.3) )*45)+
	                Double.doubleToLongBits(45.7),
					new HashUtil(23, 45).append(obj1).append(obj2).append(obj3).append(obj4).toHashCode());
			...
			assertEquals((((((((((((((((((((((23l*45)+51)*45)+60)*45)+ 121)*45)+ 127)*45)+
					...
					*45)+ Float.floatToIntBits(23.567f))*45)+(long) 'r')*45)+(long) 'e',
					new HashUtil(23,45).append(new byte[] {51,60}).append(new short[] {121,127}).append(new long[] 
			...
			assertEquals((((((((((((((((((((((23l*45)+51)*45)+60)*45)+ 121)*45)+ 127)*45)+
					...
					*45)+(long) Float.floatToIntBits(23.567f))*45)+(long) 'r')*45)+(long) 'e',
					new HashUtil(23,45).append(obj5).append(obj6).append(obj7).append(obj8).append(obj9).toHashCode());
	}
}
