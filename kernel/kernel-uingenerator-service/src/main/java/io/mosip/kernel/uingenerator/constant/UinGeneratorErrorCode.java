...
public enum UinGeneratorErrorCode {
	UIN_NOT_FOUND("KER-UIG-001", "Uin could not be found"), UIN_STATUS_NOT_FOUND("xxxx",
			"Given Uin status not found"), UIN_NOT_ISSUED("XXX", "Given UIN is not in Issued status");
