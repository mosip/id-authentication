...
public class UinFilterUtil {
	...
	private List<String> restrictedNumbers;
	...
	public boolean isValidId(String id) {
		return !(sequenceFilter(id) || restrictedFilter(id) || regexFilter(id, repeatingPattern)
	 ...
	 */
	private boolean restrictedFilter(String id) {
		return restrictedNumbers.parallelStream().anyMatch(id::contains);
	}
