package io.mosip.kernel.syncjob.config;
...
public class SwaggerConfig {
	 ...
	 */
	private static final String ADMIN_SERVICE_VERSION = "0.0.1";
	/**
	 * Application Title
	 */
	 ...
	 * Master Data Service
	 */
	private static final String DESCRIPTION = "Admin Service";
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title(TITLE).description(DESCRIPTION).version(ADMIN_SERVICE_VERSION).build();
	}
