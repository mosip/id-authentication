package org.mosip.kernel.dataaccess.test;
...
import org.mosip.kernel.dataaccess.config.impl.EclipselinkDaoConfig;
import org.mosip.kernel.dataaccess.exception.DataAccessLayerException;
import org.mosip.kernel.dataaccess.repository.impl.EclipselinkRepositoryImpl;
import org.mosip.kernel.dataaccess.test.Person.Person;
...
@SpringBootTest(classes = EclipselinkDaoConfig.class)
@TestPropertySource("classpath:/test.application.properties")
public class EclipselinkRepositoryTest {

	EclipselinkRepositoryImpl<Person, Integer> repository;
	...
	public void setUp() {
		...
		repository = new EclipselinkRepositoryImpl<Person, Integer>(information, em);
	...
	public void repositoryCreateQuerySelectNoResultExceptionTest() {
		...
		repository.create(baseEntity);
		String qlString = "SELECT c FROM Person c WHERE c.name LIKE :personName";
		doThrow(new NoResultException("Eclipselink exception")).when(query).getResultList();
	...
	public void repositoryCreateQueryUpdateOrDeleteNoResultExceptionTest() {
		...
		repository.create(baseEntity);
		String qlString = "SELECT c FROM Person c WHERE c.name LIKE :personName";
		doThrow(new NoResultException("Eclipselink exception")).when(query).executeUpdate();
