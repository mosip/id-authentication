...
package io.mosip.kernel.security.bouncycastle.constant;
...
public enum MosipSecurityExceptionCodeConstants {
	...
	MOSIP_NULL_DATA_EXCEPTION("COK-FSE-010","data is null or length is 0"),
