 ...
 * element interface generated in the genclasses package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _BIR_QNAME = new QName("http://docs.oasis-open.org/bias/ns/biaspatronformat-1.0/",
			"BIR");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema
	 * derived classes for package: genclasses
	 * 
	 */
