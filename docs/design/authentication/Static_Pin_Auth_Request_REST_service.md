...
Static Pin Auth REST service can be used to authenticate an Individual using the static pin that is stored already for the individual using [Statip Pin Storage](https://github.com/mosip/mosip/wiki/ID-Authentication-APIs#3-static-pin-storage).
