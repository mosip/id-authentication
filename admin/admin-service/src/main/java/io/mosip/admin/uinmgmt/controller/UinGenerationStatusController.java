...
public class UinGenerationStatusController {
	...
	public ResponseWrapper<List<UinGenerationStatusDto>> getPacketStatus (@PathVariable("rid") String rid) throws JsonParseException, JsonMappingException, IOException
	{
