package io.mosip.admin.test.config;
...
public class TestSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public UserDetailsService userDetailsService() {
		...
		users.add(new User("zonal-admin", "mosip",
				Arrays.asList(new SimpleGrantedAuthority("ROLE_ZONAL_ADMIN"))));
		users.add(new User("central-head", "mosip", Arrays.asList(new SimpleGrantedAuthority("ROLE_CENTRAL_HEAD"))));
		users.add(new User("center-head", "mosip", Arrays.asList(new SimpleGrantedAuthority("ROLE_CENTER_HEAD"))));
		users.add(new User("zonal-approval","mosip", Arrays.asList(new SimpleGrantedAuthority("ROLE_ZONAL_APPROVAL"))));
