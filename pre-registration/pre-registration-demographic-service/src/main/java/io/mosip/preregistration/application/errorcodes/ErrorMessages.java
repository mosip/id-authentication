...
public enum ErrorMessages {
	 ...
	 */
	PRE_REGISTRATION_TABLE_NOT_ACCESSIBLE("PRE_REGISTRATION_TABLE_NOT_ACCESSIBLE"),

	/**
	 * ErrorMessage for PRG_PAM_APP_003
	 */
	DELETE_OPERATION_NOT_ALLOWED("DELETE_OPERATION_NOT_ALLOWED"),
	 ...
	 * ErrorMessage for PRG_PAM_APP_005
	 */
	NO_RECORD_FOUND_FOR_USER_ID("NO_RECORD_FOUND_FOR_USER_ID"),

	/**
	 * ErrorMessage for PRG_PAM_APP_006
	 */
	INVAILD_STATUS_CODE("INVAILD_STATUS_CODE"),
	 ...
	 * ErrorMessage for PRG_PAM_APP_007
	 */
	JSON_VALIDATION_PROCESSING_EXCEPTION("JSON_VALIDATION_PROCESSING_EXCEPTION"),

	/**
	 * ErrorMessage for PRG_PAM_APP_007
	 */
	JSON_IO_EXCEPTION("JSON_IO_EXCEPTION"),

	/**
	 * ErrorMessage for PRG_PAM_APP_007
	 */
	JSON_SCHEMA_IO_EXCEPTION("JSON_SCHEMA_IO_EXCEPTION"),

	/**
	 * ErrorMessage for PRG_PAM_APP_008
	 */
	UNABLE_TO_UPDATE_THE_PRE_REGISTRATION("UNABLE_TO_UPDATE_THE_PRE_REGISTRATION"),

	/**
	 * ErrorMessage for PRG_PAM_APP_009
	 */
	FILE_IO_EXCEPTION("FILE_IO_EXCEPTION"),

	/**
	 * ErrorMessage for PRG_PAM_APP_009
	 */
	UNSUPPORTED_ENCODING_CHARSET("UNSUPPORTED_ENCODING_CHARSET"),

	/**
	 * ErrorMessage for PRG_PAM_DOC_015
	 */
	DOCUMENT_FAILED_TO_DELETE("DOCUMENT_FAILED_TO_DELETE"),

	/**
	 * ErrorMessage for PRG_PAM_DOC_016
	 */
	BOOKING_FAILED_TO_DELETE("BOOKING_FAILED_TO_DELETE"),
	 ...
	 * PRG_PAM_APP_005
	 */
	RECORD_NOT_FOUND_FOR_DATE_RANGE("RECORD_NOT_FOUND_FOR_DATE_RANGE"),
	...
	DOCUMENT_IS_MISSING("DOCUMENT_IS_MISSING");
