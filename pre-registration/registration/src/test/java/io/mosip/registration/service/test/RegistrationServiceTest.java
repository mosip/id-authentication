...
//		TablenotAccessibleException exception = new TablenotAccessibleException(RegistrationErrorCodes.REGISTRATION_TABLE_NOTACCESSIBLE, null);
//
...
//				RegistrationErrorCodes.REGISTRATION_TABLE_NOTACCESSIBLE);
//
