...
public class AcknowledgementConfig {
	...
	public Docket registrationStatusBean() {
		...
		Docket docket = new Docket(DocumentationType.SWAGGER_2).groupName("Pre-Registration").select()
				.apis(RequestHandlerSelectors.basePackage("io.mosip.preregistration.acknowledgement.controller"))
	...
	@Bean
    public RestTemplate restTemplateConfig() throws KeyManagementException, java.security.NoSuchAlgorithmException, KeyStoreException
                  {
