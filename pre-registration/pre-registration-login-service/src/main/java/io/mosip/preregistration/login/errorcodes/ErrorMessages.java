...
public enum ErrorMessages {
	...
	INVALID_REQUEST_ID("Invalid Request Id recieved"),//PRG_AUTH_004
	INVALID_REQUEST_VERSION("Invalid Request version recieved"),//PRG_AUTH_005
	INVALID_REQUEST_DATETIME("Invalid Request timestamp recieved"),//PRG_AUTH_006
	INVALID_REQUEST_BODY("Invalid Request recieved"),//PRG_AUTH_007
	INVALID_REQUEST_USERID("Invalid Request userId recieved"),//PRG_AUTH_008
	INVALID_REQUEST_LANGCODE("Invalid Request langcode recieved"),//PRG_AUTH_009
	INVALID_REQUEST_OTP("Invalid Request Id recieved"),//PRE_AUTH_010
