...
public class TransactionEntity extends BaseRegistrationEntity implements Comparable<TransactionEntity> {
	 ...
	 * 
	 * @param trntypecode the trntypecode to set
	 */
	 ...
	 * 
	 * @param referenceIdType the referenceIdType to set
	 */
	...
	public int compareTo(TransactionEntity o) {
		...
		return this.createDateTime.compareTo(o.getCreateDateTime());
	}
