...
public class SimplePatchForAutoGenId extends IdAuthenticationUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO) throws AuthenticationTestException, AdminTestException, SecurityXSSException {
		...
		if (testCaseDTO.getTemplateFields() != null && templateFields.length > 0) {
			...
			response = patchWithBodyAndCookieWithAutoGeneratedId(ApplnURI + testCaseDTO.getEndPoint(), inputJson,
					COOKIENAME, testCaseDTO.getRole(), testCaseDTO.getTestCaseName(), idKeyName);
