 ...
 *
 */
public class AddIdentity extends IdRepoTestsUtil implements ITest {
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, AddIdentity.testCaseName);
		} catch (Exception e) {
	...
	public void addIdentityTest(TestParameters objTestParameters, String testScenario,
			String testcaseName) {
		...
		if(testcaseName.contains("_Pos"))
			saveIdentityForUpdateIdentityVerification(JsonPrecondtion.getJsonValueFromJson(getContentFromFile(testCaseName.listFiles(), "create"), "request.identity"));
