...
public class RunConfigUtil {
	...
	private static final Logger RUNCOONFIGUTIL_LOGGER = Logger.getLogger(RunConfigUtil.class);
	...
	public static String getTestLevel() {
		RUNCOONFIGUTIL_LOGGER.info("Main: "+System.getProperty("env.testLevel"));
	...
	public static String getLinuxMavenEnvVariableKey() {
		return AuthTestsUtil.getPropertyFromFilePath(new File(RunConfigUtil.getResourcePath()+"/ida/TestData/RunConfig/envRunConfig.properties").getAbsolutePath()).get("linuxMavenEnvVarKey").toString();
	}
	...
	public static String getResourcePath() {
		return getGlobalResourcePath()+"/AuthenticationTestResource/";
	}
	
	public static String getdemoAppVersion() {
		return AuthTestsUtil.getPropertyFromFilePath(new File(RunConfigUtil.getResourcePath()+"/ida/TestData/RunConfig/envRunConfig.properties").getAbsolutePath()).get("demoAppVersion").toString();
	}
	...
	public static String getRidNumber(String keyword) {
		if (keyword.equals("$RID$")) {
			...
			return getRidForUin(getUINKey(keys[2]));		
		}
