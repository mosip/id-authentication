...
public class Audit extends BaseAudit {
			...
			public String toString() {
				return "Audit [eventId=" + eventId + ", eventName=" + eventName + ", eventType=" + eventType
						+ ", actionTimeStamp=" + actionTimeStamp + ", hostName=" + hostName + ", hostIp=" + hostIp
						+ ", applicationId=" + applicationId + ", applicationName=" + applicationName
						+ ", sessionUserId=" + sessionUserId + ", sessionUserName=" + sessionUserName + ", id=" + id
						+ ", idType=" + idType + ", createdBy=" + createdBy + ", moduleName=" + moduleName
