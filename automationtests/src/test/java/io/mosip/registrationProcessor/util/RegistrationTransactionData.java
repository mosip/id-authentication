...
/*public static void main(String[] args) {
	RegistrationTransactionData r=new RegistrationTransactionData();
	List<Integer> lis=new ArrayList<Integer>();
	System.out.println(r.getList("11100000"));
	lis=r.getList("11100000");
	System.out.println(r.setCharacter(lis));
}*/
