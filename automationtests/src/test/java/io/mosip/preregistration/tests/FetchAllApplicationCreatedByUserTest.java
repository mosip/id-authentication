...
/**
 * Test Class to perform Fetch all the applications created by user
 *  related Positive and Negative test cases
 * 
...
public class FetchAllApplicationCreatedByUserTest extends BaseTestCase implements ITest{
	...
	FetchAllApplicationCreatedByUserTest() {
		super();
	}
	...
	public void fetchAllAplicationCreatedByUser(String testSuite, Integer i, JSONObject object) throws Exception {
		...
		{
			Response createResponse = preLab.CreatePreReg();
	...
	public void updateOutput() throws IOException {
		...
		try (FileWriter file = new FileWriter(configPath)) {
			...
			logger.info("Successfully updated Results to Fetch_all_application_created_by_userOutput.json file.......................!!");
    ...
    public void setResultTestName(ITestResult result) {
          try {
                ...
                f.set(baseTestMethod, FetchAllApplicationCreatedByUserTest.testCaseName);
          } catch (Exception e) {
