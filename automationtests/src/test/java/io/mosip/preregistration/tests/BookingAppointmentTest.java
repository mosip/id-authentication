...
/**
 * Test Class to perform Booking Appointment related Positive and Negative test cases
 * 
 * @author Lavanya R
 * @since 1.0.0
 */

public class BookingAppointmentTest extends BaseTestCase implements ITest {
	/**
    ...
    public void setResultTestName(ITestResult result) {
          try {
                ...
                f.set(baseTestMethod, BookingAppointmentTest.testCaseName);
          } catch (Exception e) {
