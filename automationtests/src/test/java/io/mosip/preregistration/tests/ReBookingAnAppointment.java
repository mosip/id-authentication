...
public class ReBookingAnAppointment extends BaseTestCase implements ITest {
	...
	private static Logger logger = Logger.getLogger(ReBookingAnAppointment.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, ReBookingAnAppointment.testCaseName);
		} catch (Exception e) {
