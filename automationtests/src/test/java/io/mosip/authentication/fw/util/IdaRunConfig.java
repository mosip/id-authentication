...
public class IdaRunConfig extends RunConfig{
	...
	public  void setConfig(String testDataPath,String testDataFileName,String testType) {
		...
		setEndPointUrl(IdaScriptsUtil.getPropertyValue("endPointUrl"));
		setEkycPath(IdaScriptsUtil.getPropertyValue("ekycPath"));
		setSrcPath(IdaScriptsUtil.getPropertyValue("srcPath"));
		setAuthPath(IdaScriptsUtil.getPropertyValue("authPath"));
		setInternalAuthPath(IdaScriptsUtil.getPropertyValue("internalAuthPath"));
		setOtpPath(IdaScriptsUtil.getPropertyValue("otpPath"));
		...
		setPinPath(IdaScriptsUtil.getPropertyValue("staticPinPath"));
		...
		setDbKernelUrl(IdaScriptsUtil.getPropertyValue(System.getProperty("env.user")+".dbKernelUrl"));
		setDbIdaUrl(IdaScriptsUtil.getPropertyValue(System.getProperty("env.user")+".dbIdaUrl"));
		setDbAuditUrl(IdaScriptsUtil.getPropertyValue(System.getProperty("env.user")+".dbAuditUrl"));
		setVidGenPath(IdaScriptsUtil.getPropertyValue("vidGenPath"));
