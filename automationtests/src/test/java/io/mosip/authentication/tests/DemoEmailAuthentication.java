 ...
 *
 */
public class DemoEmailAuthentication extends IdaScriptsUtil implements ITest{

	private static Logger logger = Logger.getLogger(DemoEmailAuthentication.class);
	...
	private String TESTDATA_PATH="ida/TestData/Demo/Email/";
	private String TESTDATA_FILENAME="testdata.ida.Demo.AuthWithEmail.mapping.yml";
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, DemoEmailAuthentication.testCaseName);
		} catch (Exception e) {
