 ...
 *
 */
public class OtpFlooding extends IdaScriptsUtil implements ITest{

	private static Logger logger = Logger.getLogger(OtpFlooding.class);
	...
	private String TESTDATA_FILENAME="testdata.ida.Otp.OtpGenerationFlooding.mapping.yml";
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, OtpFlooding.testCaseName);
		} catch (Exception e) {
