 ...
 *
 */
public class InternalBioIrisAuthentication extends IdaScriptsUtil implements ITest{

	private static Logger logger = Logger.getLogger(InternalBioIrisAuthentication.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, InternalBioIrisAuthentication.testCaseName);
		} catch (Exception e) {
