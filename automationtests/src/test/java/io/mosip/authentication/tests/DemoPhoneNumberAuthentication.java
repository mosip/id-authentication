 ...
 *
 */
public class DemoPhoneNumberAuthentication extends IdaScriptsUtil implements ITest{

	private static Logger logger = Logger.getLogger(DemoPhoneNumberAuthentication.class);
	...
	private String TESTDATA_PATH="ida/TestData/Demo/PhoneNumber/";
	private String TESTDATA_FILENAME="testdata.ida.Demo.AuthWithPhoneNumber.mapping.yml";
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, DemoPhoneNumberAuthentication.testCaseName);
		} catch (Exception e) {
