 ...
 *
 */
public class StaticTokenIdGenerationForBioFingerAuth extends IdaScriptsUtil implements ITest{

	private static Logger logger = Logger.getLogger(StaticTokenIdGenerationForBioFingerAuth.class);
	...
	private String TESTDATA_PATH="ida/TestData/StaticTokenId/Bio/FingerPrint/";
	private String TESTDATA_FILENAME="testdata.ida.StaticTokenId.Bio.FingerPrint.mapping.yml";
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, StaticTokenIdGenerationForBioFingerAuth.testCaseName);
		} catch (Exception e) {
