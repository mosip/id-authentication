 ...
 *
 */
public class BioFingerAuthentication extends IdaScriptsUtil implements ITest{

	private static Logger logger = Logger.getLogger(BioFingerAuthentication.class);
	...
	private String TESTDATA_PATH="ida/TestData/Bio/FingerPrint/";
	private String TESTDATA_FILENAME="testdata.ida.bio.AuthWithFingerPrint.mapping.yml";
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, BioFingerAuthentication.testCaseName);
		} catch (Exception e) {
