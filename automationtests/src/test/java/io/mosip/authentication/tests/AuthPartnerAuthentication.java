...
/**
 * Tests to execute the Auth Partner authentication
 * 
 * @author Athila
 *
 */
public class AuthPartnerAuthentication extends IdaScriptsUtil implements ITest {
	...
	/**
	 * Test method for auth partner authentication execution
	 * 
