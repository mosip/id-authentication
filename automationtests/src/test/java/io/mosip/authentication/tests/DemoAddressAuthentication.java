 ...
 *
 */
public class DemoAddressAuthentication extends IdaScriptsUtil implements ITest{

	private static Logger logger = Logger.getLogger(DemoAddressAuthentication.class);
	...
	private String TESTDATA_PATH="ida/TestData/Demo/Address/";
	private String TESTDATA_FILENAME="testdata.ida.Demo.AuthWithAddress.mapping.yml";
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, DemoAddressAuthentication.testCaseName);
		} catch (Exception e) {
