 ...
 *
 */
public class EkycWithBioAuthentication extends IdaScriptsUtil implements ITest{

	private static Logger logger = Logger.getLogger(EkycWithBioAuthentication.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, EkycWithBioAuthentication.testCaseName);
		} catch (Exception e) {
