...
/**
 * Tests to execute OTP authentication using ekyc
 * 
 * @author Athila
 *
 */
public class EkycWithOtpAuthentication extends IdaScriptsUtil implements ITest{
	...
	private static Logger logger = Logger.getLogger(EkycWithOtpAuthentication.class);
	...
	private String TESTDATA_PATH="ida/TestData/eKYC/Otp/";
	private String TESTDATA_FILENAME="testdata.ida.eKYC.AuthWithOtp.mapping.yml";
	...
	public void idaApiBioAuthExecution(TestParameters objTestParameters,String testScenario,String testcaseName) {
		...
		Assert.assertEquals(postAndGenOutFile(testCaseName.listFiles(),
				RunConfig.getEndPointUrl() + RunConfig.getOtpPath(), "otp-generate", "otp-generate-output-res",200), true);
		//wait(30000);
		Map<String,String> tempMap = new HashMap<String, String>();
		tempMap.put("pinInfovalue", getOtpValue(objFileUtil.getFilePath(testCaseName,"bio-auth").getAbsolutePath(),mapping,"pinInfovalue"));
		logger.info("************* Modification of auth request ******************");
		Reporter.log("<b><u>Modification of auth data</u></b>");
