 ...
 *
 */
public class DemoNameAuthentication extends IdaScriptsUtil implements ITest{

	private static Logger logger = Logger.getLogger(DemoNameAuthentication.class);
	...
	private String TESTDATA_PATH="ida/TestData/Demo/Name/";
	private String TESTDATA_FILENAME="testdata.ida.Demo.AuthWithName.mapping.yml";
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, DemoNameAuthentication.testCaseName);
		} catch (Exception e) {
