 ...
 *
 */
public class StaticPinAuthentication extends IdaScriptsUtil implements ITest{

	private static final Logger logger = Logger.getLogger(StaticPinAuthentication.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, StaticPinAuthentication.testCaseName);
		} catch (Exception e) {
	...
	public void idaStaticPinStorage(TestParameters objTestParameters,String testScenario,String testcaseName) {
		...
		logger.info("************* Static pin authenticaiton request ******************");
		Reporter.log("<b><u>Static pin authentication request</u></b>");
