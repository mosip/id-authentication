 ...
 *
 */
public class EkycWithBioIrisAuthentication extends IdaScriptsUtil implements ITest{

	private static Logger logger = Logger.getLogger(EkycWithBioIrisAuthentication.class);
	...
	private String TESTDATA_PATH="ida/TestData/eKYC/Iris/";
	private String TESTDATA_FILENAME="testdata.ida.eKYC.AuthWithIris.mapping.yml";
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, EkycWithBioIrisAuthentication.testCaseName);
		} catch (Exception e) {
