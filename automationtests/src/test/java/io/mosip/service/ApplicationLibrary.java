...
public class ApplicationLibrary extends BaseTestCase {
	...
	public Response putRequestWithParameter(String Resource_URI, HashMap<String, String> path_value, JSONObject body) {
		return commonLibrary.putRequestWithPathParameter(ApplnURI + Resource_URI, path_value, body,
				MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON);
	}

	public Response putRequestWithParameterWithoutBody(String Resource_URI, HashMap<String, String> path_value) {
		return commonLibrary.putRequestWithPathParameterWithoutBody(ApplnURI + Resource_URI, path_value,
				MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON);
	}
	...
	public Response deleteRequestWithParmAndQuerry(String Resource_URI, HashMap<String, String> valueMap,
	...
	public Response putFileAndJsonWithParm(String Resource_Uri, Object body, File file, HashMap<String, String> parm) {
		return commonLibrary.Post_JSONwithFileWithParm(body, file, ApplnURI + Resource_Uri,
				MediaType.MULTIPART_FORM_DATA, parm);
	}
	...
	public Response get_Request_multiplePathAndMultipleQueryParam(String Resource_URI,
	...
	public Response getRequestPathQueryPara(String Resource_URI, HashMap<String, String> path_value,
