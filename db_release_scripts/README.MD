...
* **mosip_<schema>/ddl folder:** Contains table creation scripts for the release.

* **mosip_<schema>/dml folder:** Contains seed/master data CSVs for the release.

* **mosip_<schema>/sql folder:** SQL alter script files for the release and revoke, Specific to release version.

* **mosip_<schema>/<schema>_release_db_deploy.sh:**  Script to deploy alter scripts.

* **mosip_<schema>/<schema>_release_deploy.properties:** Parameters required for release DB deployment

* **mosip_<schema>/<schema>_revoke_db_deploy.sh:**  Script to revoke database deployment.
...
**Note:** SQL script files name under sql folder are appended with release version numbers( like **1.0**_master-scripts_release.sql), Same version number has to be passed as argument while executing release/revoke shell scripts. Ex. **$sh mosip_release_db_deployment.sh 1.0**
...
**ALTER_SCRIPT_FILENAME=** Alter scripts sql filename, This file is kept under sql directory, ex: <schema>-scripts_release.sql.
...
**REVOKE_SCRIPT_FILENAME=** Revoke scripts sql filename, This file is kept under sql directory, ex: <schema>-scripts_revoke.sql.
...
<em> **Enter:-bash-4.2$** sh mosip_release_db_deployment.sh <release_version_number> </em>
...
<em> **Enter:-bash-4.2$** sh mosip_revoke_db_deployment.sh <release_version_number> </em>
