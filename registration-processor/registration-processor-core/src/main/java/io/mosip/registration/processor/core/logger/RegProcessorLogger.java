...
public final class RegProcessorLogger {
	...
	static {
		...
		mosipRollingFileAppender.setFileName("D:/home/logs/registrationProcessor.log");
		mosipRollingFileAppender.setFileNamePattern("D:/home/logs/registrationProcessor-%d{yyyy-MM-dd}-%i.log");
