...
public class AuthUtil {
	...
	public static void main(String[] args) {
		System.out.println(DateUtils.getUTCCurrentDateTimeString());
		// System.out.println(CryptoUtil.encodeBase64("".getBytes()));
		System.out.println("#KEY_SPLITTER#".getBytes());
