...
import io.mosip.registration.processor.request.handler.service.controller.LostPacketController;
...
@RestControllerAdvice(assignableTypes = LostPacketController.class)
public class LostPacketExceptionHandler {
	...
	public ResponseEntity<Object> accessDenied(AccessDeniedException e) {
		...
		return lostPacketExceptionResponse((Exception) e);
	}
	...
	public ResponseEntity<Object> badrequest(RegBaseCheckedException e) {
		...
		return lostPacketExceptionResponse(e);
	}
	 ...
	 * @return the string
	 */
	public ResponseEntity<Object> lostPacketExceptionResponse(Exception ex) {
