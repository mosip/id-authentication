...
public class VirusScannerServiceException extends BaseUncheckedException{
    ...
    {
    	super(PlatformErrorMessages.PRP_PKR_PACKET_VISRUS_SCANNER_SERVICE_FAILED.getCode(),message);
    }
    ...
    {
    	super(PlatformErrorMessages.PRP_PKR_PACKET_VISRUS_SCANNER_SERVICE_FAILED.getCode()+EMPTY_SPACE,message,cause);
    }
}
