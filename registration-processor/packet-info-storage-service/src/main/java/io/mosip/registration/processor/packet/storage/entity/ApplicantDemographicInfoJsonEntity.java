...
@Entity
@Table(name = "applicant_demographic_new_json", schema = "regprc")
public class ApplicantDemographicInfoJsonEntity  extends BasePacketEntity<ApplicantDemographicInfoJsonPKEntity> implements Serializable {
