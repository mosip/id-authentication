package org.mosip.registration.processor.packet.manager.service.impl;
...
import org.mosip.registration.processor.packet.manager.exception.FileNotFoundInSourceException;
...
public class FileManagerImpl implements FileManager<DirectoryPathDto, InputStream> {
	 ...
	 * 
	 * @see
	 * org.mosip.id.issuance.file.system.connector.service.FileManager#get(java.lang
	 ...
	 * 
	 * @see
	 * org.mosip.id.issuance.file.system.connector.service.FileManager#put(java.lang
	 * .Object, java.lang.Object)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.mosip.id.issuance.file.system.connector.service.FileManager#
	 ...
	 * 
	 * @see
	 * org.mosip.id.issuance.file.system.connector.service.FileManager#cleanUpFile(
