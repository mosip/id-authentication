package org.mosip.registration.processor.filesystem.ceph.adapter.impl.exception.utils;
...
public final class IISPlatformErrorCodes {
	...
	public static final String IIS_EPU_ATU_CORE_KERNEL_UNAVAILABLE = IIS_EPU_ATU_GEN_MODULE + "CORE_KERNEL_UNAVAILABLE";
	public static final String IIS_EPU_ATU_DFS_NOT_ACCESSIBLE = IIS_EPU_ATU_GEN_MODULE + "DFS_NOT_ACCESSIBLE";
	public static final String IIS_EPU_ATU_CONNECTION_NOT_AVAILABLE = IIS_EPU_ATU_GEN_MODULE
			+ "CONNECTION_TO_DFS_NOT_AVAILABLE";
	public static final String IIS_EPU_ATU_INVALID_CONNECTION_PARAMETERS = IIS_EPU_ATU_GEN_MODULE
	...
	public static final String IIS_EPU_ATU_FILE_NOT_AVAILABLE = IIS_EPU_ATU_GEN_MODULE + "FILE_NOT_AVAILABLE";
