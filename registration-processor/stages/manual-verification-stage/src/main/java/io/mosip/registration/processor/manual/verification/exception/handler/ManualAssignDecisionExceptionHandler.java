 ...
 */
public class ManualAssignDecisionExceptionHandler {

	/** The reg proc logger. */
	private static Logger regProcLogger = RegProcessorLogger.getLogger(ManualAssignDecisionExceptionHandler.class);
	 ...
	 */
	public ManualAssignDecisionExceptionHandler() {
	 ...
	 * @param id the id
	 */
	public ManualAssignDecisionExceptionHandler(String id) {
		this.id=id;
	}
