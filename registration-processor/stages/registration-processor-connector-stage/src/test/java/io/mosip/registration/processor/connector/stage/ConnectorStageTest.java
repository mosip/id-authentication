...
public class ConnectorStageTest {
	...
	private void healthCheckTest() throws ClientProtocolException, IOException {
		HttpGet httpGet = new HttpGet("http://localhost:8090/registrationconnector/health");
	...
	public void connectorTest() throws ClientProtocolException, IOException{
		HttpPost httpPost = new HttpPost("http://localhost:8090/registrationconnector/v0.1/registration-processor/connector");
