...
public class PacketDecryptionFailureException extends BaseCheckedException{	
	 ...
	 *
	 * @param code            Error Code Corresponds to Particular Exception
	 * @param message            Message providing the specific context of the error.
	 * @param cause 			  Throwable cause for the specific exception
	 */
