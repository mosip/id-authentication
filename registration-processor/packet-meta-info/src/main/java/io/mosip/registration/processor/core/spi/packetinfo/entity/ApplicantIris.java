...
@NamedQuery(name="ApplicantIris.findAll", query="SELECT a FROM ApplicantIris a")
public class ApplicantIris implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ApplicantIrisPK id;
	...
	public ApplicantIris() {
		super();
	}

	public ApplicantIrisPK getId() {
		return this.id;
	}

	public void setId(ApplicantIrisPK id) {
		this.id = id;
	}
