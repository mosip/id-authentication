...
public class MessageNotificationController {
	...
	public ResponseEntity<MessageNotificationResponse> sendSms(
			@RequestBody(required = true) String templateTypeCode, String id, String idType, List<String> attributes ) {

		MessageNotificationResponse smsResponseDto = notificationService
				.sendSmsNotification(templateTypeCode, id, idType, attributes);
	...
	public ResponseEntity<MessageNotificationResponse> sendEmail(
			@RequestBody(required = true) MessageNotificationRequest messageNotificationRequest) {

		MessageNotificationResponse smsResponseDto = notificationService
				.sendEmailNotification(messageNotificationRequest);
		return ResponseEntity.status(HttpStatus.OK).body(smsResponseDto);
	}
